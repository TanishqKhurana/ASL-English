# ASL-English
A Machine Learning model using OpenCV, MediaPipe, TensorFlow etc to use your webcam to capture and sense sign language gestures to translate it into English
